...
<div class="dashboard-layout">
    <aside class="sidebar">
        ...
        <a href="{{ route('superadmin.companies') }}" class="sidebar-link active">Logistics Companies</a>
    ...
    <main class="main-content">
        <h1 class="page-title">Logistics Companies</h1>
        <div class="panel">
            <table class="table">
                <thead><tr><th>Company</th><th>Email</th><th>Active Riders</th><th>Status</th></tr></thead>
                <tbody>
                    @forelse ($all ?? [] as $user)
                        <tr>
                            <td>{{ $user->name }}</td>
                    ...
                    @empty
                        <tr><td colspan="4" style="color:var(--text-gray);">No logistics companies registered yet.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
